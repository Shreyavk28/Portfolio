...
**[https://your-live-portfolio-url.com](https://portfolio-zz13.vercel.app/)**
...
2.  **Autism Disorder Detection using Deep Learning**
    * A deep learning model using CNNs to detect ASD from facial features via live webcam analysis.
    * **Tech:** Python, TensorFlow, Keras, OpenCV, NumPy

3.  **Task Management Web App (MERN Stack)**
    * A full-stack task manager with JWT authentication, priority levels, and due-date tracking.
    * **Tech:** React.js, Node.js, Express.js, MongoDB, JWT

4.  **Expense Tracker with Insights**
    * A personal finance tracker that logs income/expenses and visualizes spending with charts.
